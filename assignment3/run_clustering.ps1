...
python run_experiment.py --rp  --dataset1 --dim 10  --skiprerun --verbose --threads -1 --seed 13 | tee rp-dataset1-clustering.log  2>&1
python run_experiment.py --rp  --dataset2 --dim 12 --skiprerun --verbose --threads -1 --seed 13 | tee rp-dataset2-clustering.log  2>&1
