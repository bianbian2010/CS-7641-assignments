...
python run_experiment.py --rp  --dataset1 --dim 8  --skiprerun --verbose --threads -1 --seed 14 | tee rp-dataset1-clustering.log  2>&1
python run_experiment.py --rp  --dataset2 --dim 12 --skiprerun --verbose --threads -1 --seed 14 | tee rp-dataset2-clustering.log  2>&1
python run_experiment.py --rf  --dataset1 --dim 11 --skiprerun --verbose --threads -1 --seed 14 | tee rf-dataset1-clustering.log  2>&1
python run_experiment.py --rf  --dataset2 --dim 20 --skiprerun --verbose --threads -1 --seed 14 | tee rf-dataset2-clustering.log  2>&1
