...
python run_experiment.py --rp  --dataset1 --dim 60  --skiprerun --verbose --threads -1 --seed 1113 | tee rp-dataset1-clustering.log  2>&1
python run_experiment.py --rp  --dataset2 --dim 60 --skiprerun --verbose --threads -1 --seed 1113 | tee rp-dataset2-clustering.log  2>&1
